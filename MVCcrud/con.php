...
class DB_CON
{
    ...
    public function insert($first_name, $last_name, $email, $password, $confirm_password, $phone, $address, $gender, $hobbies, $country, $profile_image)
    {
...
values ('$first_name','$last_name','$email','$password','$confirm_password','$phone','$address','$gender','$hobbies','$country','$profile_image')");
        return  $ret;
    }
...
address='$address',gender='$gender',hobbies='$hobbies',country='$country',profile_image='$profile_image'where id='$id'");
    ...
    {
        $deletedquery = mysqli_query($this->dbh, "delete from mvcdata where id=$rid");
        return $deletedquery;
    }
}
