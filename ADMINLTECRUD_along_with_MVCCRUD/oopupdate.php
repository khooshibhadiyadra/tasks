...
?>  <form name="update" method="post" enctype="multipart/form-data" action="">
        <div class="card-body">
            ...
            <div class="form-group">
                Phone
                <input class="form-control" type="text" name="phone" value="<?php echo $row['phone']; ?>" class="form-control" required>
            </div>
            <div class="form-group">
                Address
                <input class="form-control" type="text" name="address" value="<?php echo $row['address']; ?>" class="form-control" required>
            </div>
            <div class="form-group">
                Gender
