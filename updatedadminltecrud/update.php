            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <?php if (!empty($lastnameerr)): ?>
                        <p style='color:red;'><?php echo $lastnameerr ?></>
                    <?php endif; ?>
                </div>
                <br>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="checkbox" name="hobbies[]" value="Sports" <?php echo strpos($user['hobbies'], 'Sports') !== false ? 'checked' : ''; ?>>Sports
                ...
                <div class="form-group">
                    ...
                    <?php if (!empty($profileimageerr)): ?>
                        <p style='color:red;' class="text-red-500"><?php echo $profileimageerr ?></p>
                    <?php endif; ?>
                </div>
                <br>
