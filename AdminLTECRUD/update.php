...
<div class="card-header">
    ...
    <form action="update_action.php" method="POST" enctype="multipart/form-data">
        ...
        First Name: <input class="form-control" type="text" name="first_name" value="<?php echo $user['first_name']; ?>" required>
        </div>
        <br>
        <div class="form-group">
        Last Name: <input class="form-control" type="text" name="last_name" value="<?php echo $user['last_name']; ?>" required>
</div>
<br>
<div class="form-group">
        Email: <input class="form-control" type="email" name="email" value="<?php echo $user['email']; ?>" required>
        </div>
<br>
<div class="form-group">
        Phone: <input class="form-control" type="text" name="phone" value="<?php echo $user['phone']; ?>" required><br>
        </div>
        <br>
        <div class="form-group">
